...
% --- Display labels on figure screen (top-left corner) ---
infoText = sprintf([ ...
    'Aircraft A Speed: %d ft/s\n' ...
    'Aircraft B Speed: %d ft/s\n' ...
    'TA Threshold: %d ft\n' ...
    'RA Threshold: %d ft'], ...
    velocity_A, velocity_B, TA_threshold, RA_threshold);

% Create on-screen text box
annotation('textbox', [0.02, 0.75, 0.3, 0.2], ...  % [x y w h]
    'String', infoText, ...
    'FontSize', 11, ...
